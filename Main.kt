...
fun main() {
    ...
    println("\n $separador Perfil de Internet $separador")
    perfilInternet()
}
...
En el código inicial que se proporciona en el siguiente fragmento de código, escribe un programa que imprima los detalles
del perfil de una persona.
